...
> ANTES DE CONTINUAR: comienza por aquí, cargando estos paquetes. Si la sesión de R se cierra, deberás comenzar por aquí nuevamente.
...
```{r mapa-conceptual, echo=FALSE, fig.cap="Estrategia de corredores biológicos", out.width="80%", eval=F}
